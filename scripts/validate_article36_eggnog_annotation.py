...
def main() -> int:
    ...
    chapter_checks = {
        ...
        "linear-takeaways": "## 先确定这一点" in text,
        "linear-theory": "#sec-theory" in text,
        "linear-setup": "#sec-setup" in text,
        "linear-code": "#sec-code" in text,
        "linear-audit": "#sec-audit" in text,
        "linear-publication": "## 图中应该保留哪些信息" in text,
        "linear-pitfalls": ".callout-caution" in text,
        "linear-methods": "## #sec-methods" in text,
        "linear-own-data": "## #sec-own-data" in text,
