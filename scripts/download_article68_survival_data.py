#!/usr/bin/env python3
"""Download and checksum the public Spencer et al. inputs used by Article 68."""
...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        ...
        "license_note": "Public study data terms apply; the article panel is reproduced as a scholarly quotation for visual anchoring.",
        "resources": {},
    }
