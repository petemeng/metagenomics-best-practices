...
::: {.callout-tip title="MAG 多样性低，可能只是目录覆盖少"}
...
![Korchagina et al. 2026 Figure 5 原图。A–B 的组成来自 recovered MAG relative abundance；论文同时提醒 recovered MAGs 只代表群落子集。原图由 Springer Nature 以 CC BY 4.0 发布，未改动](../figures/22-korchagina-fig5-original.png){#fig-22-anchor}
