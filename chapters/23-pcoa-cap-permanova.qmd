...
::: {.callout-tip title="不可估计与不显著，需要在图中分开"}
...
![Korchagina et al. 2026 Figure 1 原图。地图、环境梯度和每个温泉的样本数共同说明：500 个样本不是 500 个等权独立的温泉重复。原图由 Springer Nature 以 CC BY 4.0 发布，未改动](../figures/23-korchagina-fig1-original.png){#fig-23-anchor}
