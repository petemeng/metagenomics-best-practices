...
![Wirbel et al. 2019 Figure 3。上半部比较物种与 eggNOG 模型的单队列迁移，下半部比较 study-to-study transfer 与 LOSO。原图 © Springer Nature 2019，权利归原权利人所有，仅用于学术评论，不属于本仓库 CC BY/MIT 授权内容；来源为 Nature Medicine，](../figures/28-wirbel-fig3-original.png){#fig-28-anchor}
...
::: {.callout-tip title="留一队列外测回答的是哪一种未来场景"}
