...
::: {.callout-tip title="文件能下载之后，还要怎样保证结果可追溯"}
...
![宏基因组读段与元数据的公共对象模型：Study 连接 Sample，Sample 与 Experiment 共同定义 Run，Analysis 再回指输入 Run。原图为 ten Hoopen et al. 2017 Figure 2，按 CC BY 4.0 使用并注明来源，DOI `10.1093/gigascience/gix047`](../figures/article77/77-tenhoopen-figure2-original.jpg){#fig-77-anchor}
