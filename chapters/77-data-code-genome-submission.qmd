...
## 原始数据、派生结果和代码，分别应该存在哪里？ {#sec-target}
...
## 从 accession crosswalk 开始 {#sec-code}

### 仓库按对象语义分工，不按“哪个能上传”分工 {#sec-theory}
