...
![Franzosa et al. 2019 Figure 1。原图用于定位待复现的配对组学问题；权利归原权利人所有，仅用于学术评论，不属于本仓库 CC BY/MIT 授权内容。](../figures/63-franzosa-fig1-original.png){#fig-63-anchor}
...
::: {.callout-tip title="多组学预测是否真的比单组学更有用"}
