...
::: {.callout-tip title="统一重处理解决了什么，又没有解决什么"}
...
![Manghi et al. 2026 Figure 1。cMD3 将公开 shotgun reads、MetaPhlAn 3 / HUMAnN 3 谱和标准化元数据连接起来。原图按 CC BY 4.0 使用，](../figures/26-cmd3-fig1-original.png){#fig-26-anchor}
